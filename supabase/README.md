...
4. Add the deployed Vercel URL and local development URL to Auth redirect URLs.
5. Apply `migrations/202609160001_initial_shopxzetio_schema.sql` with the Supabase CLI or SQL editor.
